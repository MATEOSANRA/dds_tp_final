...
describe("GET /api/carnetsJWT", () => {

  it("Devolveria error, porque falta token de autorización", async function () {
    const res = await request(app).get("/api/carnetsJWT");
  ...
  it("Devolvería todos los carnets, solo autorizado para administradores", async function () {
