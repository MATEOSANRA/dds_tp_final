...
router.get(
  ...
  router.post("/api/carnetsfamilias/", async function (req, res, next) {
    ...
    try {
      let data = await db.carnetsfamilias.create({
  ...
  router.put("/api/carnetsfamilias/:id", async function (req, res, next) {
    // #swagger.tags = ['CarnetsFamilias']
    ...
    /*    #swagger.parameters['CarnetsFamilias'] = {
      ...
      try {
        let data = await db.carnetsfamilias
        .update(
          { Nombre: req.body.Nombre },
          { where: { IdCarnetFamilia: req.params.id } }
        );
  ...
  router.delete("/api/carnetsfamilias/:id", async function (req, res, next) {
    // #swagger.tags = ['CarnetsFamilias']
