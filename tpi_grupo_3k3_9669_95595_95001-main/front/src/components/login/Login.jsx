...
function Login() {
  ...
  useEffect(() => {
    ...
    //https://cdn.jsdelivr.net/npm/@fortawesome/fontawesome-free@5.14.0/svgs/solid/book.svg
    AuthService.logout();
  });
      ...
      <div className="divbody text-center">
        <main className="form-signin w-100 m-auto">
          <form className="p-5">
            <img
              className="mb-4"
              src="https://cdn.jsdelivr.net/npm/@fortawesome/fontawesome-free@5.14.0/svgs/solid/book.svg"
              alt=""
              width="120"
              height="90"
            />
            <h1 className="h3 mb-3 fw-normal">Ingrese</h1>
