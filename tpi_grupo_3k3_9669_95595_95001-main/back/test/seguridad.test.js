...
describe("GET /api/librosJWT", () => {

  it("Devolveria error, porque falta token de autorización", async function () {
    const res = await request(app).get("/api/librosJWT");
  ...
  it("Devolvería todos los libros, solo autorizado para administradores", async function () {
