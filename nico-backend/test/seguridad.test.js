...
describe("GET /api/comidasJWT", () => {

  it("Devolveria error, porque falta token de autorización", async function () {
    const res = await request(app).get("/api/comidasJWT");
  ...
  it("Devolvería todos los comidas, solo autorizado para administradores", async function () {
